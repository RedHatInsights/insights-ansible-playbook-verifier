...
def test_end_to_end(
    ...
    print(signing_result.stderr.strip())
    signing_result.check_returncode()
    assert signing_result.returncode == 0
    ...
    assert signing_result.stdout.strip() == reading_result.stdout.strip()
    assert signing_result.returncode == 0
